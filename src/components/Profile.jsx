      ...
      <div className="card bg-base-300 w-full max-w-3xl mt-10 shadow-sm p-5">
        ...
        <div className="mx-6">
          ...
          {nameEdit && (
            <button
              onClick={handleSave}
              className="ml-4 bg-primary px-9 py-2 rounded-xs cursor-pointer"
            >
              Save
            </button>
          )}
        ...
        <div className="mx-6 my-10">
          <h1 className="mb-5 text-blue-500 cursor-pointer">
            Deactivate Account
          </h1>
          <h1 className="text-red-500 cursor-pointer">Delete Account</h1>
        </div>
      </div>
    </div>
  );
